...
knitr::include_graphics("../images/death-lineup.jpg")
```
...
```{r out.width='80%', echo = FALSE, fig.align="center"}
setwd("~/Desktop/C133/workout01/report")
...
library(dplyr)
death_lineup <- read.csv("../data/shots-data.csv")
pts2 <- summarise(group_by(death_lineup, name),
                  total = sum(shot_type == "2PT Field Goal"),
                  made = sum(shot_type == "2PT Field Goal"&shot_made_flag == "shot_yes"))
pts2$perc_made <- pts2$made / pts2$total
pts2 <- pts2 %>% arrange(desc(perc_made))
as.data.frame(pts2)
```
...
```{r out.width='80%', echo = FALSE, fig.align="center", message=FALSE}
pts3 <- summarise(group_by(death_lineup, name),
                  total = sum(shot_type == "3PT Field Goal"),
                  made = sum(shot_type == "3PT Field Goal"&shot_made_flag == "shot_yes"))
pts3$perc_made <- pts3$made / pts3$total
pts3 <- pts3 %>% arrange(desc(perc_made))
as.data.frame(pts3)
```
...
```{r out.width='80%', echo = FALSE, fig.align="center", message=FALSE}
pts_all <- summarise(group_by(death_lineup, name),
                  total = sum(shot_type == "2PT Field Goal"|shot_type == "3PT Field Goal"),
                  made = sum(shot_made_flag == "shot_yes"))
pts_all$perc_made <- pts_all$made / pts_all$total
pts_all <- pts_all %>% arrange(desc(perc_made))
as.data.frame(pts_all)
```
### Fire Ball Time  
...
```{r out.width='80%', echo = FALSE, fig.align="center"}
knitr::include_graphics("../images/gsw-time-chart.png")
```
...
```{r out.width='80%', echo = FALSE, fig.align="center"}
knitr::include_graphics("../images/championship.jpeg")
```
